...
function  countYearsInOffice(presidentsArr) { 
  return presidentsArr.reduce((acc , crt) => {if (crt.leftOffice === null) {return acc} 
  else {return acc + (crt.leftOffice - crt.tookOffice)}}, 0)}
...
function countRepublicanPresidents(presidentsArr) {
  return presidentsArr.reduce((acc, crt) => {if (crt.party === "Republican") {
    return acc + 1} else {return acc}},0)
  }
